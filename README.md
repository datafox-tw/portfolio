...
| 程式設計基礎與系統思維起點                         | [PBC2021-final](https://github.com/datafox-tw/PBC2021-final) <br> [windowskill]([https://github.com/datafox-tw/windowskill](https://github.com/datafox-tw/windowskill_windowOS))                                                                                               | OOP 設計、互動式系統實作、C++ 與 Python 的實作差異                              |
...
| Programming foundations                       | [PBC2021-final](https://github.com/datafox-tw/PBC2021-final) <br> [windowskill]([https://github.com/datafox-tw/windowskill](https://github.com/datafox-tw/windowskill_windowOS))                                                                                               | Object-oriented design, interactive systems, C++ vs Python implementation mindset                                    |
