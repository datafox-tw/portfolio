...
| LLM 微調 / Transformer 訓練               | Instruction tuning（QLoRA） <br> [Chinese Extractive QA（BERT）](https://github.com/datafox-tw/Chinese_Extractive_QA)                                                                                                                                                               | 參數高效微調、span prediction 訓練流程、prompt 與推論策略設計                     |
...
| CUDA加速相關迷你專題能力展示 | [CUDA Matrix Conjugate Transpose Optimization](https://github.com/datafox-tw/CUDA_Matrix_Conjugate_Transpose_Optimization) <br>  | 展示對於CUDA 執行模型與記憶體層次結構的理解 |
...
| LLM fine-tuning / Transformer                 | Instruction tuning (QLoRA) <br> [Chinese Extractive QA（BERT）](https://github.com/datafox-tw/Chinese_Extractive_QA)                                                                                                                                                             | Parameter-efficient fine-tuning, span prediction training pipeline, prompt & inference strategy design               |
| CUDA acceleration-related mini-project capability showcase | [CUDA Matrix Conjugate Transpose Optimization](https://github.com/datafox-tw/CUDA_Matrix_Conjugate_Transpose_Optimization) <br>  | Demonstrates an understanding of the CUDA execution model and memory hierarchy. |
...
| Programming foundations                       | [PBC2021-final](https://github.com/datafox-tw/PBC2021-final) <br> [windowskill](https://github.com/datafox-tw/windowskill_windowOS)                                                                                               | Object-oriented design, interactive systems, C++ vs Python implementation mindset                                    |
